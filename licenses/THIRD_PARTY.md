...
The frontend uses **Vazirmatn** through the `@fontsource/vazirmatn` npm package.

Copyright 2015 The Vazirmatn Project Authors: <https://github.com/rastikerdar/vazirmatn>

This Font Software is licensed under the SIL Open Font License, Version 1.1. The complete license text is included below and is also available at <https://scripts.sil.org/OFL>.
