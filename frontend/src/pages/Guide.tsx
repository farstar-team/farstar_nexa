...
import { ArrowLeft, BookOpen, CheckCircle2, ChevronDown, Inbox, MessageCircle, MousePointer2, Play, Workflow, Zap } from "lucide-react";
...
const steps = [
  ...
  { title: "پاسخ خودکار را طراحی کنید", text: "کلیدواژه، محصول، قیمت و اقدام‌های Flow را انتخاب کنید و ابتدا Dry Run بگیرید." },
...
const faqs = [
  ...
  ["اتوماسیون دقیقاً چه کار می‌کند؟", "وقتی پیام یا کامنت با شرط شما منطبق شود، نکسا Flow مربوط را اجرا می‌کند؛ مثلاً محصول و قیمت را پیدا می‌کند، پاسخ می‌سازد و نتیجه را ثبت می‌کند."],
